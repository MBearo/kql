...
var hasRangeKeys = function hasRangeKeys(params) {
  return Boolean((0, _lodash.keys)(params).find(function (key) {
    return ['gte', 'gt', 'lte', 'lt', 'from', 'to'].includes(key);
  }));
};

var isRangeFilter = function isRangeFilter(filter) {
  return filter && filter.range;
};

exports.isRangeFilter = isRangeFilter;

var isScriptedRangeFilter = function isScriptedRangeFilter(filter) {
