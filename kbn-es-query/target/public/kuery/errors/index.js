...
var endOfInputText = 'end of input'
...
function (_Error) {
  ...
  function KQLSyntaxError(error, expression) {
    ...
    var message = `Expected ${translatedExpectationText} but ${error.found ? "\"".concat(error.found, "\"") : endOfInputText} found.`

    var fullMessage = [message, expression, (0, _lodash.repeat)('-', error.location.start.offset) + '^'].join('\n');
